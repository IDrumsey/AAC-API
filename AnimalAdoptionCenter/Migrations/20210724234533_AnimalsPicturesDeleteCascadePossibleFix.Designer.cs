...
namespace AnimalAdoptionCenter.Migrations
{
    ...
    [Migration("20210724234533_AnimalsPicturesDeleteCascadePossibleFix")]
    partial class AnimalsPicturesDeleteCascadePossibleFix
    {
            ...
            modelBuilder.Entity("AnimalAdoptionCenterModels.FileName", b =>
                {
                    ...
                    b.HasOne("AnimalAdoptionCenterModels.Animal", "Animal")
                        .WithMany()
